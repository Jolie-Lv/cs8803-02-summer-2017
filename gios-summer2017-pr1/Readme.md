...
```
git clone https://github.gatech.edu/gios-sum-2017/gios-summer2017-pr1.git
```
...
[] (TAs should specify --provider udacity and use their personal Udacity
accounts.)
...
Bonnie will test your echoclient.c code with its own reference
...
* For this and all assignments, you may submit your code as many times as you
	like.  After the deadline, a grader download your last submission, assess
	your design and finally assigning a grade.*
...
* README (Extra points up to 5 may be given)
	...
	* Suggestions on how you would improve the documentation, sample code,
		testing, or other aspects of the project
